 ...
 <header class="main-header">
    ...
    <script charset="utf-8">
        ...
        function openFormGiftCardModal(event) {
            ...
            document.getElementById("getdata").setAttribute("onclick", "fetchGiftCardData('" + GiftCardID + "')");
        ...
        $(document).ready(function () {
            ...
            function openFormGiftCardModal(event) {
                ...
                //function fetchUserData(GiftCardID);
