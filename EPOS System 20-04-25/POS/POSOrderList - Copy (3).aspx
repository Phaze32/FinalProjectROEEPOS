<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSOrderList - Copy (3).aspx.vb" Inherits="POSOrderList" %>
...
<div class="table-responsive">
    <table>
        ...
        <tr><td><asp:Button ID="Button2" runat="server" Text="Sale"></asp:Button>
            <asp:Button ID="Button3" runat="server" Text="Received" OnClick="Common_Click"></asp:Button>
            <asp:Button ID = "Button5" runat="server" Text="Sorting" OnClick="Common_Click"></asp:Button>
            <asp:Button ID = "Button6" runat="server" Text="Underprocess" OnClick="Common_Click"></asp:Button> 
            <asp:Button ID = "Button7" runat="server" Text="Racked" OnClick="Common_Click"></asp:Button>             
        </td></tr>
