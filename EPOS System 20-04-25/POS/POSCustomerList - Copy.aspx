<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSCustomerList - Copy.aspx.vb" Inherits="POSCustomerList" %>
...
<div class="wrapper rtl rtl-inv">
 <header class="main-header">
  ...
  <script charset="utf-8">
      function openUserModalOld() {
          //alert("POSCustomerList.openUserModal");
          $("#customerModal").modal({ backdrop: "static" });
          //alert("POSCustomerList.openUserModal##2");
      ...
      $(document).ready(function () {
          ...
          function openUserModal(event) {
              ...
              document.getElementById("getdata").setAttribute("onclick", "fetchUserData('" + CustomerID + "')");
              ...
              success: function (data) {
                  ...
                  $.each(data.data, function (index, item) {
                      var row = '<tr>' +
                          ...
                          '<td>' + item.Status + '</td>' +
                          '<td>' +
                          '<button type="button" class="btn btn-sm btn-primary edit-btn" onclick="openUserModal(event)" data-CustomerID="' + item.CustomerID + '" >' +
                          'Edit</button>' +
                          '</td>' +
                          '</tr>';
...
<li class="active">Customers</li> </ol>
</section>
