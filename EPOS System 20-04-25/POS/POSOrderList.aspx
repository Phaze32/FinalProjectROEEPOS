<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSOrderList.aspx.vb" Inherits="POSOrderList" %>
...
<div class="table-responsive">
    <table>
        <tr><td><asp:Button ID="Button11" runat="server" Text="Summary" CommandName="MakeSummary"  ></asp:Button>
           <asp:Button ID="Button14" runat="server" Text="Detail" CommandName="MakeSummary"  ></asp:Button>
            <asp:Button ID="Button12" runat="server" Text="Sale"></asp:Button>
            </td></tr>
        <tr><td>
            <asp:Button ID="Button13" runat="server" Text="Received" OnClick="Common_Click"></asp:Button>
            <asp:Button ID = "Button15" runat="server" Text="Sorting" OnClick="Common_Click"></asp:Button>
            <asp:Button ID = "Button16" runat="server" Text="Underprocess" OnClick="Common_Click"></asp:Button> 
            <asp:Button ID = "Button1" runat="server" Text="Repairs" OnClick="Common_Click"></asp:Button> 
            <asp:Button ID = "Button18" runat="server" Text="Ironing" OnClick="Common_Click"></asp:Button> 
            <asp:Button ID = "Button17" runat="server" Text="Packing" OnClick="Common_Click"></asp:Button>
            <asp:Button ID = "Button22" runat="server" Text="Ready" OnClick="Common_Click"></asp:Button>            
            <asp:Button ID = "Button21" runat="server" Text="Racked" OnClick="Common_Click"></asp:Button>   
            <asp:Button ID = "Button31" runat="server" Text="Delivered" OnClick="Common_Click"></asp:Button>   
        </td></tr>
...
<div id="editrecord" runat="server">
    <asp:Label ID="LabelOrderID" runat="server" Text="OrderID:" />
    <asp:TextBox ID="TextBoxOrderID"  Width="100"  runat="server" ReadOnly="True" />
    <asp:Label ID="LabelInvoiceNo" runat="server" Text="InvoiceNo:" />
    <asp:TextBox ID="TextBoxInvoiceNo" runat="server"  ReadOnly="True" />
    <asp:Label ID="LabelOrderStatus" runat="server" Text="OrderStatus:" />
   <!-- <asp:TextBox ID="TextBoxOrderStatus"  runat="server" />  -->
    <asp:DropDownList ID="DropDownListOrderStatus" runat="server" />

    <asp:Label ID="LabelName" runat="server" Text="Customer:" />
    <asp:TextBox ID="TextBoxName" runat="server"  ReadOnly="True" />
    <asp:Label ID="LabelOrderDate" runat="server" Text="Ticket Date:" />
    <asp:TextBox ID="TextBoxOrderDate" runat="server" />
    <asp:Label ID="LabelTotalCost" runat="server" Text="Total Cost:" />
    <asp:TextBox ID="TextBoxTotalCost" runat="server" Width="100" />
    <asp:Label ID="LabelQuantity" runat="server"  Text="Quantity:" />
    <asp:TextBox ID="TextBoxQuantity" runat="server" Width="30"/>
    <asp:TextBox ID="TextBoxCustomerID" runat="server" Visible="false" />
    <asp:Button ID="ButtonSave" runat="server" Text="Save" OnClick="ButtonSave_Click" />
</div>
<!-- Added LabelError for DISPLAYING MESSAGES OR ERROR -->
<asp:Label ID="LabelError" runat="server" Text="" ForeColor="Red" Visible="False" />
<!-- Added TextBox for filtering with flexible width -->
<asp:TextBox ID="TextBoxFilter" runat="server" CssClass="flexible-width" 
    Placeholder="Enter filter criteria" AutoPostBack="True"
    OnTextChanged="Common_Click"></asp:TextBox> 
    
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" PageSize="100"
    CssClass="gridview-table" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
    <Columns>
       <asp:BoundField DataField="OrderID" HeaderText="OrderID" SortExpression="OrderID" ReadOnly="True" />
       <asp:BoundField DataField="InvoiceNo" HeaderText="InvoiceNo" SortExpression="InvoiceNo" ReadOnly="True" />
       <asp:BoundField DataField="OrderStatus" HeaderText="OrderStatus" SortExpression="OrderStatus"  />
       <asp:BoundField DataField="ForeName" HeaderText="Name" SortExpression="Name" />
 ...
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:Drycleaning_DBConnectionString %>"
    SelectCommand="SELECT * FROM [dbo].[OrderWithDetail] WHERE 
    (OrderID LIKE '%' + @Filter + '%' OR 
     InvoiceNo LIKE '%' + @Filter + '%' OR 
     OrderStatus LIKE '%' + @Filter + '%' OR 
     ForeName LIKE '%' + @Filter + '%' OR 
     PhoneNumber LIKE '%' + @Filter + '%' OR 
     OrderDate LIKE '%' + @Filter + '%')">
    <SelectParameters>
