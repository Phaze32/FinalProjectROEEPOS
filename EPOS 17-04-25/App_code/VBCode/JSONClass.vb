...
Namespace JSON_NS
    ...
    Public Class HandlerUtility
        Public Shared Function GetJsonHandlerResponse(ByVal uri As String) As String
            Try
                Using client As New System.Net.WebClient()
                    Dim responseData As String = client.DownloadString(uri)
                    Return responseData
                End Using
            Catch ex As Exception
                Console.WriteLine("Error fetching handler response: " & ex.Message)
                Return String.Empty
            End Try
        End Function
    End Class
