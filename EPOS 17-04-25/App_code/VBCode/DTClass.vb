...
Public Class DTClass
    ...
    Shared Function ConvertListToDataTable(Of T)(ByVal list As List(Of T)) As DataTable
        ...
        Return table
    End Function
    Public Shared Function DataTableToCSV(ByVal dataTable As DataTable) As String
        ...
        For Each column In dataTable.Columns
            csvString.Append(column.ColumnName & "," & vbCrLf)
        Next
        ...
        For Each row In dataTable.Rows
            For Each column In dataTable.Columns
                Dim value As String = row(column.ColumnName).ToString()
                csvString.Append(value & "," & vbCrLf)
            Next
            ' Remove the trailing comma and add a newline
            csvString.Length -= 1
            csvString.AppendLine()
