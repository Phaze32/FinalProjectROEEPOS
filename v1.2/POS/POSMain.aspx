<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSMain.aspx.vb" Inherits="POSMain" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>
<html>
<head runat="server" />
<meta charset="UTF-8">
<title>POS | EIMS-POS</title>
<%--<script type = "text/typescript" src="https://spos.tecdiary.com/cdn-cgi/apps/head/Bx0hUCX-YaUCcleOh3fM_NqlPrk.js"></script>--%>
...
<span class="logo-lg">EIMS<b>POS</b></span>
</a>
...
<input type="hidden" name="spos_token" value="fa1845c4ed1c0cac38126c23a7981a71" />
<div class="well well-sm" id="leftdiv">
<div id="lefttop" style="margin-bottom:5px;">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:DSTConnectionString %>" 
        SelectCommand="SELECT * FROM [tblPLU] WHERE ([Description] IS NOT NULL)"></asp:SqlDataSource>
...
<div class="form-group" style="margin-bottom:5px;">
<asp:TextBox name="hold_ref" value="" id="hold_ref" class="form-control kb-text" placeholder="Reference Note" OnTextChanged="hold_ref_TextChanged" runat="server"></asp:TextBox>

</div>
<div class="form-group" style="margin-bottom:5px;">

<asp:TextBox type="text" name="codeq" id="txtSearch"  class="form-control" style="z-index:2000!important;" placeholder="Search name of service"  runat="server" OnTextChanged="txtSearch_TextChanged"></asp:TextBox>
...
Post Code, City<br> <p>Date: Sat 14 Oct 2017</p>
</div>
<div id="print" class="fixed-table-container">
<div id="list-table-div">
<div class="fixed-table-header">
<table class="table table-striped table-condensed table-hover list-table" style="margin:0;z-index:-100;">
<thead>
<tr class="success">
<th>Product</th>
...
<div>   
   <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >
        <ContentTemplate>
            <asp:Button ID="Button1" runat="server" Text="Dryclean"  Height="70" Width="70" />
            <asp:Button ID="Button2" runat="server" Text="Laundry"  Height="70" Width="70" />
            <asp:Button ID="Button3" runat="server" Text="Repair"  Height="70" Width="70" />
            <asp:Button ID="Button4" runat="server" Text="Others" Height="70" Width="70" />
            <%--<asp:Button ID="Button5" runat="server" Text="ALL"  Height="70" Width="70" />--%>
            <asp:Button ID="Button5" runat="server" Text="ALL"  Height="70" Width="70" />
            <br>
...
<%--            <asp:Repeater ID="Repeater1" runat="server" DataSourceID="" >
                ...
                <ItemTemplate>
                        <button type="button"  id=' <%# "Butt_" & Eval("PLUID").ToString  %>'_ value="1" class="btn btn-both btn-flat product" 
                            onclick="base_url()">
<span class="bg-img">
<img src="../Images/POSImages/<%# Eval("ProductImage") %>" alt="<%# Eval("description") %>" style="width: 100px; height: 100px;">
</span>
&nbsp;&nbsp;&nbsp;<span><span><%# eval("Description").ToString & " " & MiscClass.myCurrencyFormatWithSymbol(Eval("price"), 2, "GBP")%></span></span>
</button>
                    </ItemTemplate>
...
<div class="btn-group">
<button style="z-index:10003;" class="btn btn-success pos-tip btn-flat" type="button" id="sellGiftCard"><i class="fa fa-credit-card" id="addIcon"></i> Sell Gift Cardtton>

lass="btn-group">ton style="z-index:10004;" class="btn btn-warning pos-tip btn-flat" type="button" id="next">ss="fa fa-chevron-right">button>
</div>
</div>
</div>
</div>
...
<li><a href="#" class="category active" id="1"><div class="menu-icon">
    <img src="../Images/POSImages/icons/no_image.png"  alt="" class="img-thumbnail img-responsive"></div>
    <div class="menu-info"><h4 class="control-sidebar-subheading">G01h4></h4><p>General</p></div>
</a></li> </ul>
</div>
</div>
</div>
...
<script style="display: none !important;">!function (e, t, r, n, c, a, l) { function i(t, r) { return r = e.createElement('div'), r.innerHTML = '<a href="' + t.replace(/"/g, '&quot;') + '"></a>', r.childNodes[0].getAttribute('href') } function o(e, t, r, n) { for (r = '', n = '0x' + e.substr(t, 2) | 0, t += 2; t < e.length; t += 2)r += String.fromCharCode('0x' + e.substr(t, 2) ^ n); return i(r) } try { for (c = e.getElementsByTagName('a'), l = '/cdn-cgi/l/email-protection#', n = 0; n < c.length; n++)try { (t = (a = c[n]).href.indexOf(l)) > -1 && (a.href = 'mailto:' + o(a.href, t + l.length)) } catch (e) { } for (c = e.querySelectorAll('.__cf_email__'), n = 0; n < c.length; n++)try { (a = c[n]).parentNode.replaceChild(e.createTextNode(o(a.getAttribute('data-cfemail'), 0)), a) } catch (e) { } } catch (e) { } }(document);</script>
    <script type="text/javascript">
var base_url = 'https://localhost/', assets = 'https://localhost/themes/default/assets/';
...
var csrf_hash = 'fa1845c4ed1c0cac38126c23a7981a71';
var lang = new Array();
