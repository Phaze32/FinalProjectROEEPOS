    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PLUID" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Image" >
                <ItemTemplate>
                    <asp:hyperlink id="link" runat="server" NavigateUrl='<%# "http://www.escapade.co.uk/" & Eval("PLUID") & ".asp?Category_type=SALE&Brand_ID= " & Eval("PLUID") & " "%>' Target="_blank">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [ProductImage],[PLUID], [Description],  [Type], [Price], [Department], [QtySold], [QtySoldYTD], [ValueSoldYTD], [ValueSold], [Barcode], [CurrentStockQty], [EditedBy], [Category] 
    FROM [tblPLU] where Description <> '' ">
