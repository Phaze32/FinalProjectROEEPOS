...
ManaPro.filterSuperSlider = function(id, o) {
	jQuery('#val1').html(_format(_round(o.appliedFrom)));
	jQuery('#val2').html(_format(_round(o.appliedTo)));
    var _changing = false;
	...
	jQuery('#val1').html(_format(_round(value[0])));
	jQuery('#val2').html(_format(_round(value[1])));
     jQuery('#left_price-range-from').val(_format(_round(value[0]))); 
	 jQuery('#left_price-range-to').val(_format(_round(value[1]))); 
	  jQuery('#left_price').val(_format(_round(value[1]))); 
