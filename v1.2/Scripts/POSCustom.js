...
$(document).ready(function () {
    ...
    function get_product(Product_ids) {
        //alert('hh')
        alert('POSCustom.js.ln:242 Product_ids=' + Product_ids);


        $.ajax({
            type: "GET",
            url: "GetProduct.aspx",
            data: "act=addShipbill&cntr=" + cntr + "&Shipping_ID=" + Shipping_ID + "&Productid=" + Product_ids + "&iProductTotal=" + iProductTotal + "&PaymentVia=" + PaymentVia + "&postcode=" + GetPostCode(),
...
function get_submenu(Department_Code) {
        //alert('hh')
        alert('POSCustom.js.ln:242 Department_Code=' + Department_Code);


        $.ajax({
            type: "GET",
            url: "GetSubmenu.aspx",
            data: "act=Department_Code=" + Department_Code ,
            success: function (msg) {
                $("#divSubMenu").html(msg);
