...
<%-- <link href="https://spos.tecdiary.com/themes/default/assets/dist/css/styles.css" rel="stylesheet" type="text/css" />--%>
 ...
 <script type="text/javascript" >
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (row) {
                        ...
                        tableBody.append(`
                        <tr class="table-row" data-ticket-id="${row.TicketID}" style="color: ${getRowColor(row.DaysToCollect, row.OrderStatus)};">
                            <td>${row.TicketID}</td>
            ...
            function loadFormInvoiceModal(ticketID) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#CollectDate").text(formattedDate || "N/A");
                        $("#TicketTotal").text(data.data[0].TicketTotal || "N/A");
        ...
        function getRowColor(daysToCollect, orderStatus) {
            if (daysToCollect > 0 && orderStatus !== "Delivered") {
                return "blue"; // Blue for active orders awaiting collection
            } else if (daysToCollect > 0 && orderStatus === "Delivered") {
                return "green"; // Green for delivered orders still within collection time
            } else if (daysToCollect < 0 && orderStatus !== "Delivered") {
                return "red"; // Red for overdue, undelivered orders
            }
...
<div class="button-container">
    <button class="btn btn-secondary">All</button>  <!-- New button -->
    <button class="btn btn-info">Received</button>  <!-- New button -->
    <button class="btn btn-primary">Under Process</button>
    <button class="btn btn-warning">Due Today</button>
