...
<form id="form2" runat="server">
    <div style="display:none"> <asp:Literal runat="server" ID="Literal2"  ></asp:Literal></div>
    <asp:ScriptManager ID="ScriptManager1" runat="server"  ViewStateMode="Disabled" ></asp:ScriptManager>
    <span id="hiddenLiteral" style="display: none;">
    <asp:Literal runat="server" ID="Literal_TicketID" >007###########</asp:Literal>
    </span>
    <div id="main-wrapper">
                    ...
                    <td style="width: 460px;">
                        ...
                        <div id="pos">
                            <form action="pos/posmain02.aspx" id="pos-sale-form" method="post" accept-charset="utf-8">
                                <input  name="spos_token" value="1479a37b6443485bdaaf75fb256d1484" style="display:none;" />
                                <input  id="TicketID" name="TicketID" value="007" style="display:none;" />
                                ...
                                <div class="well well-sm" id="leftdiv">
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        ...
                                        <div class="form-group" id="Customerinfo" style="margin-bottom:5px;">
                                           ...
                                           <input  id="customer_id_Selected" name="customer_id_Selected" style="display:none;" />
                                            <input  id="customer_CustomerAccNo" name="customer_CustomerAccNo"  style="display:none;"  />
                                        </div>
                                        <div class="form-group" style="margin-bottom:5px;">
                                    ...
                                    <input  name="spos_note" value="" id="spos_note"  style="display:none;" >
                                    <div id="payment-con"  style="display:none;" >
                                        <input name="amount" id="amount_val" value="" />
                                        <input name="balance_amount" id="balance_val" value="" />
                                        <input  name="paid_by" id="paid_by_val" value="cash" />
                                        <input  name="cc_no" id="cc_no_val" value="" />
                                        <input  name="paying_gift_card_no" id="paying_gift_card_no_val" value="" />
                                        <input  name="cc_holder" id="cc_holder_val" value="" />
                                        <input  name="cheque_no" id="cheque_no_val" value="" />
                                        <input  name="cc_month" id="cc_month_val" value="" />
                                        <input  name="cc_year" id="cc_year_val" value="" />
                                        <input  name="cc_type" id="cc_type_val" value="" />
                                        <input  name="cc_cvv2" id="cc_cvv2_val" value="" />
                                        <%--<input type="hidden" name="balance" id="balance_val" value="" />--%>
                                        <input  name="payment_note" id="payment_note_val" value="" />
                                        <input  name="customer" id="customer" value="3" />
                                        <input  name="order_tax" id="tax_val" value="" />
                                        <input  name="order_discount" id="discount_val" value="" />
                                        <input  name="count" id="total_item" value="" />
                                        <input  name="did" id="is_delete" value="0" />
                                        <%--<input type="hidden" name="eid" id="is_delete" value="0" />--%>
                                        <input  name="total_items" id="total_items" value="0" />
                                        <input  name="total_quantity" id="total_quantity" value="0" />
                                  </div>
                                    ...
                                    <asp:UpdatePanel  EnableViewState="false" ID="upPan" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <div id= "divSubMenu" class="" style="background-color:aqua;" >
                                                <div id="TicketNo" onclick="welcomeFunction();">
                                                    <asp:Literal ID="Literal_OrderID" runat="server"></asp:Literal>
                                                </div>
                                            </div>
                                            <br>
                                            <div id="PODsContainer" style="float:left">
                                                <asp:Literal ID="Literal1" EnableViewState="false" runat="server" Visible="true"></asp:Literal>
