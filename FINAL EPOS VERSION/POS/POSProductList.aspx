...
<div class="content-wrapper">
        ...
        <h1>Products 
            <button id="addProductBtn" class="plus-button" onclick="openProductRecordModal(event); return false;" data-pluid="0" >
...
<script>
     function openProductRecordModal(event) {
        ...
        const button = event.currentTarget;
         ...
         const pluid = button.getAttribute('data-pluid') || 0;
         if (pluid == 0) {
             document.getElementById("proModalLabel").innerHTML = "ADD PRODUCT";
         };
...
Copyright &copy; 2025 POS. All rights reserved.
</footer>
</div>
