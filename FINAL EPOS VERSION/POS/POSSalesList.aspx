<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSSalesList.aspx.vb" Inherits="POSSalesList" %>
...
<div id="editrecord" runat="server">
    <asp:Label ID="LabelTicketID" runat="server" Text="Ticket ID:" />
    <asp:TextBox ID="TextBoxTicketID" runat="server" ReadOnly="True" />
    <asp:Label ID="LabelSurname" runat="server" Text="Surname:" />
    <asp:TextBox ID="TextBoxSurname" runat="server" />
    <asp:Label ID="LabelCustomerAccNo" runat="server" Text="Customer Acc No:" />
    <asp:TextBox ID="TextBoxCustomerAccNo" runat="server" />
    <asp:Label ID="LabelTicketDate" runat="server" Text="Ticket Date:" />
    <asp:TextBox ID="TextBoxTicketDate" runat="server" />
    <asp:Label ID="LabelTicketTotal" runat="server" Text="Ticket Total:" />
    <asp:TextBox ID="TextBoxTicketTotal" runat="server" />
    <asp:Label ID="LabelPiecesTotal" runat="server" Text="Pieces Total:" />
    <asp:TextBox ID="TextBoxPiecesTotal" runat="server" />
    <asp:Button ID="ButtonSave" runat="server" Text="Save" OnClick="ButtonSave_Click" />
</div>
<asp:Label ID="LabelError" runat="server" Text="" ForeColor="Red" Visible="False" />
<script type="text/javascript">
    function openInvoicePopup(button) {
        // Retrieve TicketID from the button's data attribute
        const ticketID = button.getAttribute("data-ticketid");

        // Construct the popup URL using TicketID
        const popupUrl = `TestInvoicePopupJson.html?TicketID=${ticketID}`;
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="TicketDate" HeaderText="Ticket Date" SortExpression="TicketDate" />
        <asp:BoundField DataField="TicketTotal" HeaderText="Ticket Total" SortExpression="TicketTotal" />
        <asp:BoundField DataField="PiecesTotal" HeaderText="Pieces Total" SortExpression="PiecesTotal" />
        <asp:CommandField ShowSelectButton="True" />
       
        <asp:TemplateField>
            <ItemTemplate>
 <button class="invoice-popup-btn" data-ticketid='<%# Eval("TicketID") %>' onclick="openInvoicePopup(this); return false;">
                    View Invoice
...
<%-- <script src="https://spos.tecdiary.com/themes/default/assets/dist/js/spos_ad.min.js"></script> --%>
    ...
    <script src="../scripts/pos.min.js" type="text/javascript"></script>
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT TicketDate AS TicketDate,SUM(CONVERT(float, TicketTotal)) AS TicketTotal, SUM(CONVERT(int, PiecesTotal)) AS PiecesTotal, 
        ...
        GROUP BY TicketDate,TicketID,dbo.tblTicket.CustomerAccNo, tc.Surname,tc.Forename
