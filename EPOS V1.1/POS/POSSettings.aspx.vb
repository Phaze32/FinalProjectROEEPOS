Imports System.Data
Partial Class Styles_POSSettings
    ...
    Private Sub Styles_POSSettings_Load(sender As Object, e As EventArgs) Handles Me.Load

    End Sub

    Private Sub Styles_POSSettings_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
