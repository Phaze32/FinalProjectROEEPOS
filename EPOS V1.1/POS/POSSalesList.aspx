...
<asp:TableCell   ColumnSpan="12" CssClass="p0">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TicketTotal" HeaderText="TicketTotal" SortExpression="TicketTotal" ReadOnly="True" >
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="PiecesTotal" HeaderText="PiecesTotal" SortExpression="PiecesTotal" ReadOnly="True" >
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT YEAR(TicketDate) AS year, MONTH(TicketDate) AS month, DAY(TicketDate) AS day
    , SUM(CONVERT(float, TicketTotal)) AS TicketTotal, SUM(CONVERT(int, PiecesTotal)) AS PiecesTotal, TicketID
FROM dbo.tblTicket GROUP BY YEAR(TicketDate), MONTH(TicketDate), DAY(TicketDate), TicketID order by ticketid desc">
