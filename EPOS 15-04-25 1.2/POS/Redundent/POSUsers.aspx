<%@ Page Language="VB"   AutoEventWireup="false" EnableViewState="false" CodeFile="POSUsers.aspx.vb" Inherits="POS_POSUsers"  Debug="true"  %>
...
<body class="skin-green sidebar-collapse sidebar-mini pos"   >
    ...
    <div id="main-wrapper">
        payment-con<aside class="control-sidebar control-sidebar-dark" id="categories-list">
