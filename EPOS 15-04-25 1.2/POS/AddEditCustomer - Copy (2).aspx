...
<script runat="server">
    ...
    private void AddCustomer()
    {
        ...
        var connectionString = "Drycleaning_DBConnectionString";
    ...
    private void SearchCustomers()
    {
        ...
        var tableName = "[dbo].[tbl_customers]";
        var connectionString = "Drycleaning_DBConnectionString";
        var sqlquery = "SELECT * FROM " + tableName + " WHERE Forename LIKE @query OR Surname LIKE @query OR PhoneNumber like @query";
