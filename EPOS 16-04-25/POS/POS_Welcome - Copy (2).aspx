<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POS_Welcome - Copy (2).aspx.vb" Inherits="POS_Welcome" %>
...
<div class="box-body">
<a class="btn btn-app" href="/POS/posmain02.aspx">
...
<a class="btn btn-app" href="/POS/sales/opened">

<i class="fa fa-bell-o"></i> Opened Bills </a>
<a class="btn btn-app" href="/POS/categories">
<i class="fa fa-folder-open"></i> Categories </a>
<a class="btn btn-app" href="/POS/gift_cards">
<i class="fa fa-credit-card"></i> Gift Card </a>
<a class="btn btn-app" href="/POS/customers">
<i class="fa fa-users"></i> Customers </a>
<a class="btn btn-app" href="/POS/POSSettings.aspx">
<i class="fa fa-cogs"></i> Settings </a>
<a class="btn btn-app" href="/POS/reports">
<i class="fa fa-bar-chart-o"></i> Reports </a>
<a class="btn btn-app" href="/POS/users">
<i class="fa fa-users"></i> Users </a>
<a class="btn btn-app" href="/POS/backups">
...
<div class="box box-primary">
<div class="box-header">
<h3 class="box-title">Top Products (October 2017)</h3>
</div>
<div class="box-body">
