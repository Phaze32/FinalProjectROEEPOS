...
<title>Settings | The Subhan is a king POS</title>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function loadFormInvoiceModal(ticketID) {
                // Logic to populate FormInvoiceModal with data for the given TicketID
                $.ajax({
                    url: `/Handlers/InvoiceDetailHandler.ashx?TicketID=${ticketID}`, // Adjust path to your handler
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        const modalBody = $('#tsModal tbody'); // Adjust selector for modal body
                        modalBody.empty(); // Clear modal content
