<%@ Page Language="VB" AutoEventWireup="false" CodeFile="POSOrderList - Copy (2).aspx.vb" Inherits="POSOrderList" %>
...
<div class="table-responsive">
    <table>
        ...
        <tr><td><asp:Button ID="Button2" runat="server" Text="Sale"></asp:Button>
            <asp:Button ID="Button3" runat="server" Text="Received" OnClick="Button3_Click"></asp:Button>
            <asp:Button ID = "Button5" runat="server" Text="Sorting" OnClick="Button5_Click"></asp:Button>
            <asp:Button ID = "Button6" runat="server" Text="Underprocess" OnClick="Button6_Click"></asp:Button> 
            <asp:Button ID = "Button7" runat="server" Text="Racked" OnClick="Button7_Click"></asp:Button>             
        </td></tr>
...
<div id="editrecord" runat="server">
    ...
    <asp:TextBox ID="TextBoxTotalCost" runat="server" />
...
<asp:TextBox ID="TextBoxFilter" runat="server" CssClass="flexible-width" 
    ...
    OnTextChanged="TextBoxFilter_TextChanged"></asp:TextBox> 
...
<asp:SqlDataSource ID="SqlDataSource3" runat="server" 
    ...
    (OrderID LIKE '%' + @Filter + '%' OR 
     ...
     OrderDate LIKE '%' + @Filter + '%')">
    <SelectParameters>
        <asp:ControlParameter Name="Filter" ControlID="TextBoxFilter" 
            PropertyName="Text" DefaultValue="%" />
    </SelectParameters>
</asp:SqlDataSource>
<asp:SqlDataSource ID="SqlDataSource11" runat="server" 
        ConnectionString="<%$ ConnectionStrings:Drycleaning_DBConnectionString %>" 
        SelectCommand="select * from [dbo].[OrderWithDetail]">
